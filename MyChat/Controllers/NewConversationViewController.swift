...
class NewConversationViewController: UIViewController {
    ...
    private let tableView: UITableView = {
        ...
        table.register(NewConversationCell.self,
                       forCellReuseIdentifier: NewConversationCell.indentifier)
        return table
    }()
...
extension NewConversationViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: NewConversationCell.indentifier, for: indexPath) as! NewConversationCell
...
extension NewConversationViewController: UISearchBarDelegate {
    ...
    func filterUsers(with term: String) {
        ...
        let safeEmail = DatabaseManager.safeEmail(emailId: currentUserEmail)
